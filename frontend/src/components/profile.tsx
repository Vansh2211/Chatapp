      ...
      {isMenuVisible && (
        <div className="sidebar">
          ...
          <ul className="sidebar-list">
            ...
            <li className="sidebar-item" onClick={handleRequest}>Requests</li>
        ...
        {user && (
            ...
            <p> <b>Name: {localStorage.getItem("name")}</b></p>
            <p><b>Email: {localStorage.getItem("email")}</b></p>
            <p><b>Mobile: {localStorage.getItem("mobile")}</b></p>
            </div>
        )}
        {error && <p>{error}</p>}
        </div>
